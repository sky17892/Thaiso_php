...
class __TwigTemplate_5fbc1d42a2b87e92b11b4f156e42b35c extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Exporting a raw query");
  ...
  ";
    ...
    {
        return new Source("", "table/export/index.twig", "/chun0620/www/myadmin/templates/table/export/index.twig");
    }
}
