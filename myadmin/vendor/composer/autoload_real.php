...
class ComposerAutoloaderInit30dc56dbcd95b1f5db28729d0c4615c4
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInit30dc56dbcd95b1f5db28729d0c4615c4::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequire30dc56dbcd95b1f5db28729d0c4615c4($fileIdentifier, $file);
        }
 ...
 * @return void
 */
function composerRequire30dc56dbcd95b1f5db28729d0c4615c4($fileIdentifier, $file)
{
