...
class Hybrid_Providers_Line extends Hybrid_Provider_Model_OAuth2
{
    ...
    */
    function loginBegin()
    {
        ...
        Hybrid_Auth::storage()->set("line_state_token", $token);
	...
	*/
    //https://developers.line.com/docs/login/profile/
	function getUserProfile()
	{
        $response = $this->profile("/profile");
        ...
        $this->user->profile->username 		= isset($data->displayName) ? $data->displayName : '';
        $this->user->profile->displayName   = $this->user->profile->username;
        $this->user->profile->birthDay 		= '';
        $this->user->profile->birthMonth 	= '';
        $this->user->profile->email         = isset($data->email) ? $data->email : '';
    ...
    {
        $token = Hybrid_Auth::storage()->get("line_state_token");
        $params = array(
        ...
        Hybrid_Auth::storage()->set("line_state_token", null);
