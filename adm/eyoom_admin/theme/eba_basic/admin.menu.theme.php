...
//            array('100000', '환경설정', G5_ADMIN_URL . '/config_form.php', 'config'),
    if (isset($menu['menu100'])) {
        unset($menu['menu100']);
        $menu['menu100'] = array(
            array('100000', '환경설정', G5_ADMIN_URL . '/config_form2.php', 'config'),
            array('100100', '기본환경설정', G5_ADMIN_URL . '/config_form2.php', 'cf_basic'),
...
if ($member['mb_id'] == $config['cf_admin'] || in_array('member', $mg_auth)) {
    if (isset($menu['menu200'])) {
        ...
        $menu['menu200'] = array(
            ...
            array('200120', '<span style="color:blue;">총판관리</span>', G5_ADMIN_URL . '/distributor_list.php', 'mb_list'),
            array('200130', '<span style="color:blue;">총판포인트정산</span>', G5_ADMIN_URL . '/set_point.php', 'scf_item'),
...
if ($member['mb_id'] == $config['cf_admin'] || in_array('shop', $mg_auth)) {
    if (defined('G5_USE_SHOP') && G5_USE_SHOP && isset($menu['menu400'])) {
        ...
        $menu['menu400'] = array(
            ...
            array('400330', '<span style="color:blue;">타임어택</span>', G5_ADMIN_URL . '/shop_admin/timesale.php', 'scf_item'),
