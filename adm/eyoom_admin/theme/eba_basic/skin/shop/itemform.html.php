        ...
        <div class="<?php echo $w=='u' ? 'tab-pane ': ''; ?>" id="anc_sitfrm_ini" role="tabpanel" aria-labelledby="anc_sitfrm_ini_tab">
            <div class="adm-form-table m-b-20">
                ...
                <div class="adm-form-tr">
                    ...
                    <div class="adm-form-td td-r">
                        <label class="input">
                            <input type="text" name="it_name" placeholder="태국어입력" value="<?php echo get_text(cut_str($it['it_name'], 250, "")); ?>" id="it_name" required>
                        </label>
                        <label class="input">
                            <input type="text" name="it_10"  placeholder="한국어입력"  value="<?php echo get_text(cut_str($it['it_10'], 250, "")); ?>" id="it_10" required>
                        </label>
                ...
                <div class="adm-form-tr adm-sm-100">
                    <div class="adm-form-td td-l">
                        <label for="it_explan" class="label">태국어 설명</label>
                    </div>

                    <div class="adm-form-td td-r">
                        <div class="textarea">
							 <textarea name="it_9_subj" id="it_9_subj" class="h120"><?php echo $it['it_9_subj']; ?></textarea>
							 <p class="help-block">태국어 설명</p>
                        </div>
                    </div>
                </div>
                <div class="adm-form-tr adm-sm-100">
