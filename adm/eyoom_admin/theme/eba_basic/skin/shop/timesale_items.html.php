...
<div class="admin-member-list">
    <div class="adm-headline adm-headline-btn" style="overflow:hidden">
       ...
       <input type="file" id="input-file" style="display:none">
		...
		<a href="<?php echo G5_ADMIN_URL; ?>/?dir=shop&amp;pid=carexcel&amp;wmode=1" onclick="return eb_modal(this.href);return false;" class="btn-e btn-e-green "><i class="fas fa-plus"></i> 상품정보 엑셀등록</a>
		<a href="<?php echo G5_ADMIN_URL; ?>/?dir=shop&amp;pid=specexcel&amp;wmode=1" onclick="return eb_modal(this.href);return false;" class="btn-e btn-e-green "><i class="fas fa-plus"></i> 제원정보 엑셀등록</a>
		<a href="<?php echo G5_ADMIN_URL; ?>/?dir=shop&amp;pid=colorexcel&amp;wmode=1" onclick="return eb_modal(this.href);return false;" class="btn-e btn-e-green "><i class="fas fa-plus"></i> 색상정보 엑셀등록</a>


			<a href="#" onclick="jQuery(<?php echo G5_ADMIN_URL; ?>'#input-file').click()" class="btn-e btn-e-red " style="background:#669900"> <i class="fas fa-plus"></i> 엑셀 등록</a> 
			<a href="<?php echo G5_ADMIN_URL; ?>/?dir=shop&pid=car_form" class="btn-e btn-e-red "><i class="fas fa-plus"></i> 상품 등록</a>
        </div>
		<?php } ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="inline-group">
                                <span>
                                    <label class="input form-width-100px">
                                        <input type="text" id="hope_it_name" name="hope_it_name" value="<?php echo $hope_it_name; ?>" maxlength="10" style="width:180px;">
                                    </label>
                                </span>
                            </div>
                        </td>
        ...
        <div class="col col-9">
            <div class="padding-top-5">
                <span class="font-size-12 color-grey">
                    <a href="<?php echo G5_ADMIN_URL; ?>/?dir=<?php echo $dir; ?>&amp;pid=<?php echo $pid; ?>">[전체목록]</a><span class="margin-left-10 margin-right-10 color-light-grey">|</span>총상품수 <?php echo number_format($total_count); ?>건<?php if (!$wmode) { ?> 중,
    <?php } ?>
                </span>
            </div>
        </div>
...
// 번호	이미지	출력	차분류	제조사	상품명	상품가	렌탈료	기간	등록일	기타안내
    ...
    db.clients   = [
        <?php for ($i=0; $i<count((array)$list); $i++) { ?>
        {
            ...
            가격: "<?php echo number_format($list[$i]['it_price']); ?>",
...
function set_date(today) {
    ...
    function add_ts(it_id,ts_id) {
		//alert(ts_id);
        //if (confirm("자료를 정말 삭제하시겠습니까?")) {
            parent.modaliframe2.location.href = "<?php echo G5_ADMIN_URL; ?>/?dir=shop&pid=timesale_update&it_id="+it_id+"&ts_id="+ts_id+"&w=ac";
       // }
    }
</script>