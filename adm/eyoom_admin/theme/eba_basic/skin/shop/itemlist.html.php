            ...
            <div class="adm-form-tr">
                ...
                <div class="adm-form-td td-r">
					...
					<?
						...
						if ($stx) {
							if ($sfl && in_array($sfl, ['it_name', 'it_10', 'it_id', 'it_maker', 'it_origin', 'it_sell_email', 'it_1', 'it_2'])) {
                        ...
                        <span>
                            <label class="select" style="width:200px">
                                <select name="sfl" id="sfl">
                                    <option value="it_name" <?php echo get_selected($sfl, 'it_name'); ?>>상품명-태국어</option>
                                    <option value="it_10" <?php echo get_selected($sfl, 'it_10'); ?>>상품명-한국어</option>
                ...
                <div class="adm-form-td td-r">
                    <div class="inline-group search-item-type">
                        ...
                        <label class="radio" for="itype1">
                            <input type="radio" name="itype" id="itype1" value="1" <?php echo $itype == '1' ? 'checked': ''; ?>><i></i>타이소추천
                        </label>
                        <label class="radio" for="itype2">
                            <input type="radio" name="itype" id="itype2" value="2" <?php echo $itype == '2' ? 'checked': ''; ?>><i></i><span class="text-orange">타임어택<span>
                        </label>
                        <label class="radio" for="itype3">
                            <input type="radio" name="itype" id="itype3" value="3" <?php echo $itype == '3' ? 'checked': ''; ?>><i></i><span class="text-crimson">인기10</span>
                        </label>
                        <label class="radio" for="itype4">
                            <input type="radio" name="itype" id="itype4" value="4" <?php echo $itype == '4' ? 'checked': ''; ?>><i></i><span class="text-teal">고객PICK</span>
                        </label>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
							...
							<label class='input width-400px'>태국어<br><input type='text' name='it_name[<?php echo $i; ?>]' id='it_name_<?php echo $i; ?>' value='<?php echo get_text($list[$i]['it_name']); ?>' required></label><label class='input width-400px'>한국어<br><input type='text' name='it_10' id='it_10' value='<?php echo get_text($list[$i]['it_10']); ?>' placeholder="한국어 상품명을 입력하세요"></label><div class='item-type-divider'></div><div class='item-type-box'><div class='inline-group item-type-group'><label class='checkbox' for='it_type1_<?php echo $i; ?>'><input type='checkbox' name='it_type1[<?php echo $i; ?>]' id='it_type1_<?php echo $i; ?>' value='1' <?php echo $list[$i]['it_type1'] ? 'checked': ''; ?>><i></i><span>타이소추천</span></label><label class='checkbox' for='it_type2_<?php echo $i; ?>'><input type='checkbox' name='it_type2[<?php echo $i; ?>]' id='it_type2_<?php echo $i; ?>' value='1' <?php echo $list[$i]['it_type2'] ? 'checked': ''; ?>><i></i><span class='text-orange'>타임어택</span></label><label class='checkbox' for='it_type3_<?php echo $i; ?>'><input type='checkbox' name='it_type3[<?php echo $i; ?>]' id='it_type3_<?php echo $i; ?>' value='1' <?php echo $list[$i]['it_type3'] ? 'checked': ''; ?>><i></i><span class='text-crimson'>인기10</span></label><label class='checkbox' for='it_type4_<?php echo $i; ?>'><input type='checkbox' name='it_type4[<?php echo $i; ?>]' id='it_type4_<?php echo $i; ?>' value='1' <?php echo $list[$i]['it_type4'] ? 'checked': ''; ?>><i></i><span class='text-teal'>고객PICK</span></label><!-- <label class='checkbox' for='it_type5_<?php echo $i; ?>'><input type='checkbox' name='it_type5[<?php echo $i; ?>]' id='it_type5_<?php echo $i; ?>' value='1' <?php echo $list[$i]['it_type5'] ? 'checked': ''; ?>><i></i><span class='text-purple'>할인</span></label --></div></div>
                        </td>
                        <td>
