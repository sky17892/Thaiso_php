        ...
        <div class="tab-pane" id="anc_cf_sns" role="tabpanel" aria-labelledby="anc_cf_sns_tab">
            <div class="adm-form-table m-b-20">
                ...
                <div class="adm-form-tr-wrap">
                    ...
                    <div class="adm-form-tr tr-r">
                        <div class="adm-form-td td-l">
                            <label for="check_social_payco" class="label">라인 소셜로그인</label>
                        </div>
                        <div class="adm-form-td td-r">
                            <label class="checkbox">
                                <input type="checkbox" name="cf_social_servicelist[]" id="check_social_line" value="line" <?php echo option_array_checked('line', $config['cf_social_servicelist']); ?>><i></i> 라인 로그인을 사용합니다
                            </label>
                            <div class="note"><strong>Note:</strong> 라인 CallbackURL : <?php echo get_social_callbackurl('line', false, true); ?></div>
                        </div>
                    </div>
            ...
            <div class="adm-form-table m-b-20">
                ...
                <div class="adm-form-tr-wrap">
                    <div class="adm-form-tr tr-l">
                        <div class="adm-form-td td-l">
                            <label for="cf_line_clientid" class="label">라인 Channel ID</label>
                        </div>
                        <div class="adm-form-td td-r">
                            <div class="input input-button">
                                <input type="text" name="cf_line_clientid" id="cf_line_clientid" value="<?php echo get_sanitize_input($config['cf_line_clientid']); ?>">
                                <a href="https://developers.line.biz/en/docs/" target="_blank" class="button"><input type="button" class="btn_frmline">등록하기<i class="fas fa-external-link-alt m-l-7"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="adm-form-tr tr-r">
                        <div class="adm-form-td td-l">
                            <label for="cf_line_secret" class="label">라인 Channel secret</label>
                        </div>
                        <div class="adm-form-td td-r">
                            <label class="input">
                                <input type="text" name="cf_line_secret" id="cf_line_secret" value="<?php echo get_sanitize_input($config['cf_line_secret']); ?>">
                            </label>
                        </div>
                    </div>
                </div>
