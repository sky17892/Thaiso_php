...
<div class="ranking-box">
    <ul class="nav nav-tabs eb-ranking-tabs">
        <li><a href="#rank-1" data-bs-toggle="tab" class="active">วันนี้<?php echo $levelset['gnu_name']; ?></a></li>
        <li><a href="#rank-2" data-bs-toggle="tab">ทั้งหมด<?php echo $levelset['gnu_name']; ?></a></li>
        <li><a href="#rank-3" data-bs-toggle="tab"><?php echo $levelset['eyoom_name'] ? $levelset['eyoom_name']: 'ระดับ'; ?></a></li>
    </ul>
                ...
                <ul class="list-unstyled">
                    ...
                    <li>
                        <div class="width-60 float-start ellipsis">
                            ...
                            <span class="ranking-lv-icon"><img src="<?php echo $rankinfo['eyoom_icon']; ?>" alt="ระดับ"></span>
                            <?php } ?>
                        </div>
                    ...
                    <p class="text-center text-gray m-t-20 m-b-20"><i class="fas fa-exclamation-circle"></i> ไม่มีการจัดอันดับที่จะแสดง</p>
                    <?php } ?>
                </ul>
            </div>
        </div>
