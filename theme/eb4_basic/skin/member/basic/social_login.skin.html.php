...
#sns_login .social-login li .line-sl-btn {background:#03C73C}
...
<div id="sns_login">
    <h5><strong>เข้าสู่ระบบด้วยบัญชีโซเชียลมีเดียของคุณ</strong></h5>
    <ul class="social-login">
        <?php if( social_service_check('line') ) {     //LINE 로그인을 사용한다면 ?>
        <li><a href="<?php echo $self_url;?>?provider=line&amp;url=<?php echo $urlencode;?>" class="social_link line-sl-btn" title="LINE"><img src="<?php echo EYOOM_THEME_URL; ?>/image/social/line.png"><span>LINE Login</span></a></li>
        <?php }     //end if ?>
