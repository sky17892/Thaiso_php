...
<div class="member-skin contents-box-inner">
    ...
    <section class="member-box">
        <header><h5 class="m-0 f-w-700">เงื่อนไขการสมัครสมาชิก</h5></header>
        ...
        <footer>
            <fieldset class="fregister-agree">
                <label class="checkbox" for="agree11">
                    <input type="checkbox" name="agree" value="1" id="agree11"><i></i>ฉันยอมรับเนื้อหาของเงื่อนไขการสมัครสมาชิก
                </label>
            </fieldset>
        </footer>
    </section>
    ...
    <section class="member-box">
        <header><h5 class="m-0 f-w-700">คำแนะนำเกี่ยวกับนโยบายการจัดการข้อมูลส่วนบุคคล</h5></header>
        <div class="member-agree">
        ...
        <footer>
            <fieldset class="fregister-agree">
                <label class="checkbox" for="agree21">
                    <input type="checkbox" name="agree2" value="1" id="agree21"><i></i>ฉันยอมรับเนื้อหาของคำแนะนำเกี่ยวกับนโยบายการจัดการข้อมูลส่วนบุคคล
                </label>
            </fieldset>
        </footer>
    </section>
        ...
        <div class="content-box-body">
            <div class="fregister-agree text-center">
                <label class="checkbox" for="agree_all">
                    <input type="checkbox" name="agree_all" value="1" id="agree_all"><i></i><span>ฉันยอมรับข้อกำหนดทั้งหมด</span>
                </label>
            </div>
        </div>
    </div>
    ...
    <div class="register-btn-box text-center">
        <button class="btn-e btn-e-xl btn-navy" type="submit" value="สมัครสมาชิก"><i class="fas fa-sign-in-alt"></i> สมัครสมาชิก</button>
    </div>
