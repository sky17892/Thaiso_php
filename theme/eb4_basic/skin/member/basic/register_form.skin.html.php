    ...
    <div class="register-box">
        ...
        <fieldset>
            ...
            <div class="row">
				...
				<?php if ($is_member) { ?>
					<section class="col-lg-4">
						<label for="reg_mb_hp" class="label">보유포인트</label>
						<div style="border:1px solid #ddd;padding:8px">
							<?php echo display_point($member['mb_point']); ?>
						</div>
					</section>
				<?php } ?>
            </div>
            ...
            <div class="row">
                <section class="col-lg-12">
                    <label for="reg_mb_address_image" class="label">주소 이미지첨부</label>
                    <div class="input m-b-10">
                        <input type="file" class="form-control" id="reg_mb_address_image" name="mb_address_image" value="파일선택">
                    </div>
                    <div class="clearfix"></div>
                    <?php 
        ...
        <fieldset>
            ...
            <div class="row">
                ...
                <?php if ($w=='' && $config['cf_use_recommend']) { 
					...
					?>
                <section class="col-lg-6">
                    <label for="reg_mb_recommend" class="label">추천코드</label>
                    <label class="input">
                        <i class="icon-prepend fas fa-user"></i>
                        <i class="icon-append fas fa-question-circle"></i>
                        <input type="text" name="mb_recommend" id="reg_mb_recommend" value="<?=$Order_chu_Cookie?>">
                        <b class="tooltip tooltip-top-right">추천코드를 남겨주세요.</b>
                    </label>
                </section>
                <?php } ?>
