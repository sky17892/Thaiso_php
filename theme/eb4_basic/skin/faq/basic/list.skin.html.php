...
<div class="faq-wrap">
    ...
    <div class="faq-<?php echo $fm_id; ?>">
        ...
        <i class="fas fa-exclamation-circle"></i> ยังไม่มี FAQ ที่ลงทะเบียนไว้ หากต้องการลงทะเบียน FAQ ใหม่ กรุณาใช้เมนูจัดการ FAQ
            <?php if ($is_admin) { ?>
        <br>ยังไม่มี FAQ ที่ลงทะเบียนไว้ หากต้องการลงทะเบียน FAQ ใหม่ กรุณาใช้เมนูจัดการ FAQ
            <?php } ?>
        </div>
            <?php } ?>
        <?php } ?>
    ...
    <div class="faq-search-form">
        ...
        <div class="input input-button">
            <input type="text" name="stx" value="<?php echo $stx; ?>" required id="stx" size="15" maxlength="15" placeholder="การค้นหา">
            <div class="button"><input type="submit" value="검색">การค้นหา</div>
        </div>
        </form>
    </div>
</div>
