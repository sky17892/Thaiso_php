...
<style>
.left-main img{max-width:970px;width:100%}
...
<div class="qa-list">
    ...
    <div class="board-info m-b-20">
        ...
        <div class="float-end">
            ...
            <?php } ?>
            <?php if ($write_href) { ?>
            <a href="<?php echo $write_href; ?>" class="btn-e btn-e-lg btn-navy" type="button">เขียนเสร็จสมบูรณ์</a>
            <?php } ?>
        </div>
        <?php } ?>
    ...
    <div class="tab-scroll-category">
        ...
        <div id="tab-category">
            <div class="category-list">
                <span <?php if ($sca == '') { ?>class="active"<?php } ?>><a href="<?php echo $category_href; ?>">ทั้งหมด</a></span>
    ...
    <div class="ql-wrap">
        <div class="ql-head <?php if ($is_checkbox) { ?>ql-head-checkbox<?php } ?>">
            <div class="ql-item ql-num <?php if ($is_checkbox) { ?>ql-num-checkbox<?php } ?>">
                <?php if ($is_checkbox) { ?>
                <label for="chkall" class="sound_only">โพสต์ทั้งหมดในหน้าปัจจุบัน</label>
                <label class="checkbox">
                    <input type="checkbox" id="chkall" onclick="if (this.checked) all_checked(true); else all_checked(false);"><i></i>
                </label>
                <?php } ?>
                <span class="ql-txt">หมายเลข</span>
            </div>
            <div class="ql-subj">ชื่อเรื่อง</div>
            <div class="ql-item ql-author">ผู้เขียน</div>
            <div class="ql-item">สถานะ</div>
            <div class="ql-item">วันที่ลงทะเบียน</div>
        </div>
        ...
        <div class="ql-no-list">
            <i class="fas fa-exclamation-circle"></i> ไม่มีรายการโพสต์ 
        </div>
        <?php } ?>
    </div>
    <div class="qa-list-footer">
        ...
        <div class="qlf-right">
            <?php if ($write_href) { ?>
            <a href="<?php echo $write_href; ?>" class="btn-e btn-e-sm btn-navy" type="button">เขียนเสร็จสมบูรณ์</a>
            <?php } ?>
        </div>
    </div>
