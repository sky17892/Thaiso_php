...
<div class="shop-wishlist">
    ...
    <div class="wishlist-act-btn">
        <button type="submit" class="btn-e btn-e-brd btn-e-xl btn-e-dark" onclick="return fwishlist_check(document.fwishlist,'');"><i class="fas fa-shopping-cart m-r-5"></i>ตะกร้าสินค้า 담기</button>
        <button type="submit" class="btn-e btn-e-xl btn-e-navy" onclick="return fwishlist_check(document.fwishlist,'direct_buy');"><i class="fas fa-credit-card m-r-5"></i>สั่งซื้อ</button>
    </div>
    </form>
</div>
<?php /* ---------- 위시리스트 끝 ---------- */ ?>
