...
<div class="shop-personalpay-form">
    ...
    <div class="personalpay-form-wrap">
                    ...
                    <table>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <label for="pp_name" class="hidden-lg hidden-md">ชื่อ<strong class="sound_only"> 필수</strong></label>
        ...
        <div class="payment-select-wrap">
            <div class="headline-short"><h4><strong>วิธีการชำระเงิน</strong></h4></div>
