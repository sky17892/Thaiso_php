            ...
            <div class="width-200px">
                ...
                <label class="select">
                    <select name="sfl" id="sfl" required class="form-control">
                        ...
                        <option value="b.it_name"    <?php echo get_selected($sfl, "b.it_name", true); ?>>ชื่อสินค้า</option>
                        ...
                        <option value="a.iq_name"    <?php echo get_selected($sfl, "a.iq_name"); ?>>ผู้เขียน명</option>
                        <option value="a.mb_id"      <?php echo get_selected($sfl, "a.mb_id"); ?>>ผู้เขียน아이디</option>
                    </select>
                    <i></i>
                </label>
            </div>
