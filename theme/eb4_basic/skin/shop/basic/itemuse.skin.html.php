...
<section class="shop-product-use">
    ...
    <div class="product-use-top">
        ...
        <div class="product-use-btn">
            <a href="<?php echo $itemuse_form; ?>" onclick="itemuse_modal(this.href); return false;" class="btn-e btn-e-md btn-e-navy">เขียนรีวิว</a>
            ...
            <div id="sit_use_con_<?php echo $k; ?>" class="product-use-cont">
                ...
                <div class="product-use-reply">
                    ...
                    <div class="product-use-reply-name">
                        <?php echo $info['is_reply_name']; // 답변자 ชื่อ ?>
                    </div>
    ...
    <?php } else { ?>
    <p class="text-center text-gray m-t-20 m-b-40"><i class="fas fa-exclamation-circle"></i> ไม่มีรีวิวของผู้ใช้</p>
    <?php } ?>
</section>
