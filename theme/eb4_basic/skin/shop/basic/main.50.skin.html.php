...
.product-main-50 .product-img-in:before {content:"";display:block;padding-top:100%;background:#fff;position:absolute}
...
.product-main-50 .product-img-in img {display:block;max-width:100% !important;height:auto !important;top:0;left:0;right:0;bottom:0}
...
.product-main-50 .rgba-banner {height:18px;width:70px;line-height:18px;color:#fff;font-size:.6875rem;text-align:center;font-weight:400;position:relative;text-transform:uppercase;margin-bottom:1px;display:none}
...
.product-main-50 .slick-next, .product-main-50 .slick-prev {width:50px;height:50px;line-height:50px;text-align:center;border:1px solid #e5e5e5;-webkit-transition:all .2s linear;transition:all .2s linear;opacity:0}
                ...
                <?php } ?>
                    <div class="product-img">
                        <div class="product-img-in">
                                <center><?php echo $list[$i]['it_image']; ?></center>
