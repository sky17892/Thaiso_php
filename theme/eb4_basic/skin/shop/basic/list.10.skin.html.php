...
.product-list-10 .product-description .product-info {position:relative;overflow:hidden;color:#959595;font-size:.8125rem;margin-top:0px}
...
@media (max-width:767px) {
    ...
    .product-list-10 .item-list-wrap {width:50%;padding:10px 2px;border-bottom:10px solid #eee;margin-bottom:10px}
    .product-list-10 .item-list-wrap:nth-child(3n+1) {clear:none}
    .product-list-10 .item-list-wrap:nth-child(2n+1) {clear:left}
    .product-type-list .product-list-10 .item-list-wrap {width:100%;padding:10px px}
	.product-list-10 .product-description .product-name a {font-size:10pt;font-weight:normal}
...
.product-list-10 .product-description .product-info {
    position: relative;
    overflow: hidden;
    color: #959595;
    font-size: 10pt;
...
@media (max-width:500px) {
	...
	.product-description-in {height:140px}
}
</style>
    ...
    <div class="item-list-wrap">
        <div class="item-list">
            ...
            <div class="product-description-bottom">
                <a class="float-start" href="<?php echo G5_SHOP_URL; ?>/itemuselist.php?sfl=a.it_id&stx=<?php echo $list[$i]['it_id']; ?>">รีวิว</a>
