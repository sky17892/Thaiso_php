...
<section class="shop-product-qa">
    ...
    <div class="product-qa-btn">
        <a href="<?php echo $itemqa_form; ?>" onclick="itemqa_modal(this.href); return false;" class="btn-e btn-e-md btn-e-navy">เขียนสอบถามสินค้า</a>
        <a href="<?php echo $itemqa_list; ?>" class="btn-e btn-e-md btn-e-dark">ดูเพิ่มเติม</a>
    </div>
    ...
    <?php } else { ?>
    <p class="text-center text-gray m-t-20 m-b-40"><i class="fas fa-exclamation-circle"></i> ไม่มีการสอบถามข้อมูลผลิตภัณฑ์</p>
    <?php } ?>
</section>
