            ...
            <div class="order-table">
                <table>
                    <tbody>
                        ...
                        <tr>
                            <th scope="row"><label for="od_b_hp">โทรศัพท์มือถือ	
</label></th>
                            <td>
                                <label for="od_b_hp" class="label hidden-lg hidden-md">โทรศัพท์มือถือ	
</label>
                                <label class="input width-200px">
...
<style type="text/css">
	...
	.shop-order-form .payment-select-wrap .payment-select-box {width:100% !important}
                        ...
                        <tr>
                            <th scope="row"><label for="order_address_image" class="label">แนบรูปภาพที่อยู่xxx</label></th>
                            <td id="sod_frm_addr">
								<div class="row">
    ...
    <div class="order-payment-info">
        ...
        <div class="payment-select-wrap">
            ...
            <input type="radio" id="od_settle_iche" name="od_settle_case" value="계좌이체" <?php echo $checked; ?>><label for="od_settle_iche" class="payment-select-box iche_icon" style="display:none"><?php echo $escrow_title; ?>계좌이체</label>
            <?php $checked = ''; } ?>

            <?php if($default['de_hp_use']) { $multi_settle++; // 휴대폰 사용 ?>
            <input type="radio" id="od_settle_hp" name="od_settle_case" value="휴대폰" <?php echo $checked; ?>><label for="od_settle_hp" class="payment-select-box hp_icon" style="display:none">휴대폰</label>
            <?php $checked = ''; } ?>

            <?php if($default['de_card_use']) { $multi_settle++; // 신용카드 사용 ?>
            <input type="radio" id="od_settle_card" name="od_settle_case" value="신용카드" <?php echo $checked; ?>><label for="od_settle_card" class="payment-select-box card_icon" style="display:none">신용카드</label>
            <?php $checked = ''; } ?>
