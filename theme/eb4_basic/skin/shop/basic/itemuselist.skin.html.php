            ...
            <div class="width-200px">
                ...
                <label class="select">
                    <select name="sfl" id="sfl" required class="form-control">
                        ...
                        <option value="b.it_name"   <?php echo get_selected($sfl, "b.it_name"); ?>>ชื่อสินค้า</option>
                        ...
                        <option value="a.is_name"   <?php echo get_selected($sfl, "a.is_name"); ?>>ผู้เขียน명</option>
