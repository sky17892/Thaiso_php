	...
	.shop-order-form .payment-select-wrap .payment-select-box {width:100% !important}
            ...
            <div class="row">
                <section class="col-lg-12">
                    <label for="order_address_image" class="label">แนบรูปภาพที่อยู่</label>
                ...
                <div class="payment-select-wrap">
                    ...
                    <div class="payment-point-use-box">
                        <div class="payment-point-use">
                            <label for="od_temp_point" class="float-start">จุดใช้งาน<?php echo $point_unit; ?>Point</label>
                            <div class="float-end width-120px">
                                <input type="hidden" name="max_temp_point" value="<?php echo $temp_point; ?>">
                                <label class="input">
                                <i class="icon-append font-style-normal">Point</i>
                                <input type="text" name="od_temp_point" value="0" id="od_temp_point" size="7">
                                </label>
                            </div>
                        </div>
                        <div class="payment-point-use">
                            <strong class="float-start">พอยท์</strong><span class="float-end"><?php echo number_format($member['mb_point']); ?> Point</span>
                            <div class="clearfix"></div>
                            <strong class="float-start">ระดับสูงสุดที่มีอยู่</strong><strong class="float-end text-black"><?php echo number_format($temp_point); ?> Point</strong>
                        </div>
                    </div>
                    <?php $multi_settle++; } ?>
