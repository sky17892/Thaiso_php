...
add_stylesheet('<link rel="stylesheet" href="'.G5_SHOP_SKIN_URL.'/skin.70.css">', 0);
...
for ($i=1; $row=sql_fetch_array($result); $i++) {
    ...
    if ($i == 1) {
        echo "<div class=\"view70 view70_{$this->type}\"><a href=\"#\"><img src=\"".G5_SHOP_URL."/img/no_image.gif\" alt=\"\"></a></div><div id=\"smt_{$this->type}\" class=\"smt_70_wrap\"><ul class=\"sct smt_70\">\n";
    }
...
if ($i > 1) echo "</ul>\n <div id=\"smt_{$this->type}_page\" class=\"smt_70_page\"></div></div>";
...
jQuery(window).load(function(){
    if ($('#smt_<?php echo $this->type;?> .sct_noitem').length <= 0) {
        var smt60 = new Swiper('#smt_<?php echo $this->type;?>',{
            ...
            loopedSlides: 2,
            loop: true,
            paginationElementClass: 'smt70p',
            paginationActiveClass: 'smt70a',
            paginationVisibleClass: 'smt70v',
            ...
            onSwiperCreated:function(){
              var hrefff=$('#smt_<?php echo $this->type;?> .swiper-slide-active .sct_img a').attr('href');
               $('.view70_<?php echo $this->type;?> a').attr('href',hrefff);
