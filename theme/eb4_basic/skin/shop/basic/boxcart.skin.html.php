...
<div id="sbsk" class="op-area">
    ...
    <?php } ?>
    <a href="<?php echo G5_SHOP_URL; ?>/cart.php" class="btn-e btn-e-lg btn-e-block btn-e-dark btn-e-brd">ตะกร้าสินค้า 바로가기<i class="far fa-arrow-alt-circle-right m-l-5"></i></a>
    </form>
</div>