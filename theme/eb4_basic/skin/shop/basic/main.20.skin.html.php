...
.product-main-20 .slick-next, .product-main-20 .slick-prev {width:50px;height:50px;line-height:50px;text-align:center;border:1px solid #e5e5e5;-webkit-transition:all .2s linear;transition:all .2s linear;opacity:0}
...
@media (max-width:1199px) {
	...
	.product-main-20 .product-description .product-name {position:relative;overflow:hidden;margin:10px 0 5px;font-size:10pt;font-weight:700;line-height:1.4;height:auto;letter-spacing:-1px}
	.product-main-20 .product-description .title-price {font-size:10pt;font-weight:700;color:#ab0000;margin-right:7px}
	.product-main-20 .product-description .line-through {font-size:.9375rem;color:#959595;text-decoration:line-through;font-weight:700;white-space:nowrap}
}
@media (max-width:767px) {
    ...
    .product-main-20 .slick-next {right:2px}
 	.product-main-20 .product-description .product-description-in {height:140px}
