...
<div class="shop-couponzone">
    <div class="m-b-40">
        <div class="headline-short">
            <h4><strong>ดาวน์โหลดคูปอง</strong></h4>
        </div>
        <blockquote class="hero m-b-30">
            <p class="p-li"><i class="fas fa-info-circle"></i>หากคุณเป็นสมาชิก Thaiso คุณสามารถดาวน์โหลดคูปองและใช้งานได้ทันที</p>
        </blockquote>
        ...
        <?php } else { ?>
        <p class="text-center text-gray m-t-50 m-b-50"><i class="fas fa-exclamation-circle"></i> ไม่มีคูปองที่สามารถใช้ได้</p>
        <?php } ?>
    </div>

    <div id="point_coupon">
        <div class="headline-short">
            <h4><strong>พอยท์ คูปอง</strong></h4>
        </div>
        <blockquote class="hero m-b-30">
            <p class="p-li"><i class="fas fa-info-circle"></i>คุณสามารถแลกคะแนนสมาชิก Thaiso ที่คุณมีเป็นคูปองได้</p>
        </blockquote>
            ...
            <div class="couponzone-box">
                <div class="couponzone-box-pd">
                    <div class="couponzone-box-in">
                        ...
                        <div class="couponzone-desc">พอยท์ <strong class="text-crimson"><?php echo number_format($po_list[$i]['cz_point']); ?></strong>점 차감</div>
        ...
        <?php } else { ?>
        <p class="text-center text-gray m-t-50 m-b-50"><i class="fa fa-exclamation-circle"></i> ไม่มีคูปองที่สามารถใช้ได้</p>
        <?php } ?>
    </div>
</div>
