...
<style>
.product-main-10 {position:relative;overflow:hidden}
.product-main-10-in {margin-left:-10px;margin-right:-10px}
.product-main-10 .item-main-40 {position:relative;padding-left:10px;padding-right:10px;outline:none}
.product-main-10 .item-main-40-in {position:relative;background:#fff;margin-bottom:20px;-webkit-transition:all 0.2s ease-in-out;transition:all 0.2s ease-in-out}
...
.product-main-10 .item-main-40-in:hover .product-img-in .second-img {display:block}
...
.product-main-10 .rgba-banner {height:18px;width:70px;line-height:18px;color:#fff;font-size:.6875rem;text-align:center;font-weight:400;position:relative;text-transform:uppercase;margin-bottom:1px;display:none}
.product-main-10 .item-main-40-in:hover .product-name a {text-decoration:underline}
.product-main-10 .slick-dotted.slick-slider {margin-bottom:40px}
.product-main-10 .slick-dots li {display:inline-block;margin:0 1px;width:30px;height:3px;background:#959595}
.product-main-10 .slick-dots li button:before {content:"";width:100%;height:3px;-webkit-transition:all .2s linear;transition:all .2s linear;opacity:1}
.product-main-10 .slick-dots li.slick-active button:before {background:#ab0000}
.product-main-10 .slick-next, .product-main-10 .slick-prev {width:50px;height:50px;line-height:50px;text-align:center;border:1px solid #e5e5e5;-webkit-transition:all .2s linear;transition:all .2s linear;opacity:0}
.product-main-10 .slick-next:hover, .product-main-10 .slick-prev:hover {border:1px solid #757575}
.product-main-10 .slick-next {top:inherit;bottom:-60px;right:10px;z-index:1}
.product-main-10 .slick-prev {top:inherit;bottom:-60px;left:10px;z-index:1}
.product-main-10 .slick-next:before, .product-main-10 .slick-prev:before {font-family:'Font Awesome\ 5 Free';font-weight:900;color:#000;font-size:.9375rem;line-height:inherit}
...
@media (max-width:1199px) {
    ...
    .product-main-10 .item-main-40 {padding:0 5px}
    .product-main-10 .slick-next {right:5px}
    .product-main-10 .slick-prev {left:5px}
}
@media (max-width:767px) {
    .product-main-10-in {margin-left:-2px;margin-right:-2px}
    .product-main-10 .item-main-40 {padding:0 2px}
    .product-main-10 .slick-next {right:2px}
    .product-main-10 .slick-prev {left:2px}
	.product-main-10 .product-description .product-name {position:relative;overflow:hidden;margin:10px 0 5px;font-size:10pt;font-weight:700;line-height:1.4;height:auto;letter-spacing:-1px}
	.product-main-10 .product-description .title-price {font-size:10pt;font-weight:700;color:#ab0000;margin-right:7px}
	.product-main-10 .product-description .line-through {font-size:.9375rem;color:#959595;text-decoration:line-through;font-weight:700;white-space:nowrap}
	.product-main-10 .product-description .product-description-in {height:140px}
...
<div class="product-main-10">
    <div class="product-main-10-in">
        ...
        <div class="item-main-40">
            <div class="item-main-40-in">
                ...
                <div class="product-description-bottom">
                    <a class="float-start" href="<?php echo G5_SHOP_URL; ?>/itemuselist.php?sfl=a.it_id&stx=<?php echo $list[$i]['it_id']; ?>">ดูรีวิว</a>
        ...
        <p class="text-center text-gray m-t-50 m-b-50"><i class="fas fa-exclamation-circle"></i> ไม่มีสินค้าในระบบ</p>
        <?php } ?>
    </div>
</div>
