		...
		<div class="container">
			<div class="footer-top">
				<div class="footer-nav">
					<a href="<?php echo get_eyoom_pretty_url('page','provision'); ?>">ข้อกำหนดในการให้บริการ</a>
					<a href="<?php echo get_eyoom_pretty_url('page','privacy'); ?>">นโยบายความเป็นส่วนตัว</a>
					<a href="<?php echo get_eyoom_pretty_url('page','noemail'); ?>">ปฏิเสธการรวบรวมที่อยู่อีเมลโดยไม่ได้รับอนุญาต</a>
				</div>
			...
			<div class="footer-cont-info"  style="text-align:left">
				<?php if ($is_admin == 'super' && !G5_IS_MOBILE) { ?>
				<div class="adm-edit-btn btn-edit-mode hidden-xs hidden-sm" style="top:-31px;text-align:left">
					<div class="btn-group" style="text-aling:left">
...
<div class="sidebar-shop-member-wrap">
    <div class="sidebar-shop-trigger sidebar-shop-member-btn pc-btn" style="width:50px"><i class="fas fa-shopping-cart"></i><a href="https://page.line.me/025htpny" target="_blank"><img src="/img/line.svg" style="width:100%;margin:5px 0px"></a><a href="https://www.facebook.com/profile.php?id=61569466251936" target="_blank"><img src="/img/facebook.png" style="width:100%;border-radius:10px" ></a></div>
