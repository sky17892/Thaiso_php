        ...
        <div class="header-title">
            <div class="container">
                ...
                <?php } else if ($logo == 'image') { ?>
                    ...
                    <?php } else { ?>
                    <img src="/img/thaiso.png" class="site-logo" alt="<?php echo $config['cf_title']; ?>">
                    <?php } ?>
                    <?php } else { ?>
            ...
            <div class="container">
                <nav class="navbar navbar-expand-lg">
                    <div class="sidebar-left offcanvas offcanvas-start" tabindex="-1" id="offcanvasLeft" aria-controls="offcanvasLeftLabel">
						...
						<div class="m_view"><a href="https://page.line.me/025htpny" target="_blank"><img src="/img/line.svg" style="width:40px;margin:5px 5px"></a><a href="https://www.facebook.com/profile.php?id=61574644814694" target="_blank"><img src="/img/facebook.png" style="width:40px;border-radius:10px" ></a></div>
						</div>
                    </div>
                </nav>
            </div>
